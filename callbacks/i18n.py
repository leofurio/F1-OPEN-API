...
@callback(
    output=[
        ...
        Output("tab-strategy", "label"),
        Output("tab-ranking", "label"),
        Output("tab-race-control-weather", "label"),
        Output("tab-overtakes-position", "label"),
...
def translate_ui(lang):
    ...
    return [
        ...
        t(lang, "tab_strategy"),
        t(lang, "tab_ranking"),
        t(lang, "tab_race_control_weather"),
        t(lang, "tab_overtakes_position"),
