...
TRANSLATIONS = {
    "it": {
        ...
        "tab_all_laps": "Confronto tutti i giri della session selezionata",
        ...
        "laps_select_two": "Seleziona due giri per confrontarli.",
    ...
    "en": {
        ...
        "tab_all_laps": "All session laps comparison",
        ...
        "laps_select_two": "Select two laps to compare.",
