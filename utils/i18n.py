...
TRANSLATIONS = {
    "it": {
        ...
        "tab_strategy": "Strategia gomme / pit",
        "tab_ranking": "Classifica giri",
        "tab_race_control_weather": "Race Control + Meteo",
        "tab_overtakes_position": "Overtakes + Position",
        ...
        "meetings_loaded_fallback_latest": "Circuiti caricati: {count}. Ultimo GP disponibile: {year} - {meeting}.",
        ...
        "strategy_prompt": "Seleziona sessione e due piloti per vedere strategia gomme, pit stop e degrado.",
        "stints_title": "Stint e compound",
        "stints_none": "Nessuno stint disponibile.",
        "pit_title": "Pit stop e durata",
        "pit_y": "Durata pit (s)",
        "pit_none": "Nessun pit stop disponibile.",
        "deg_title": "Performance e degrado (tempi giro)",
        "deg_none": "Nessun giro con tempo disponibile.",
        "compound_unknown": "Compound sconosciuto",
        "strategy_driver_summary": "{driver}: stints {count}, ultimo compound {compound}",
        "ranking_title": "Classifica giro per giro",
        "ranking_prompt": "Carica una sessione per vedere l'andamento posizione per tutti i piloti.",
        "ranking_no_position": "Dati posizione non disponibili per questa sessione.",
        "ranking_computed_note": "Classifica stimata dai tempi giro (posizioni non fornite dalla sessione).",
        "rcw_prompt": "Carica una sessione per vedere meteo ed eventi race control.",
        "rcw_weather_none": "Dati meteo non disponibili per questa sessione.",
        "rcw_race_control_none": "Nessun evento race control disponibile per questa sessione.",
        "rcw_temp_title": "Temperature pista e aria",
        "rcw_conditions_title": "Meteo: umidita, vento e pioggia",
        "rcw_time": "Tempo UTC",
        "rcw_temp_y": "Temperatura (°C)",
        "rcw_humidity_y": "Umidita (%)",
        "rcw_wind_y": "Vento (m/s)",
        "rcw_summary_weather": "Ultimo meteo: pista {track}, aria {air}, umidita {humidity}, vento {wind}, pioggia {rain}.",
        "rcw_summary_events": "Eventi race control: {count}. Ultimo evento: {event}.",
        "rcw_event_unknown": "evento non disponibile",
        "rcw_table_title": "Timeline Race Control",
        "rcw_table_time": "Ora UTC",
        "rcw_table_category": "Categoria",
        "rcw_table_flag": "Flag",
        "rcw_table_lap": "Lap",
        "rcw_table_driver": "Pilota",
        "rcw_table_message": "Messaggio",
        "op_prompt": "Carica una sessione per vedere posizioni e sorpassi.",
        "op_position_none": "Dati posizione non disponibili per questa sessione.",
        "op_overtakes_none": "Nessun sorpasso disponibile per questa sessione.",
        "op_summary_positions": "Campioni posizione disponibili: {count}.",
        "op_summary_overtakes": "Sorpassi registrati: {count}.",
        "op_position_title": "Timeline posizioni",
        "op_time": "Tempo UTC",
        "op_position_y": "Posizione",
        "op_table_title": "Ultimi sorpassi",
        "op_table_time": "Ora UTC",
        "op_table_overtaker": "Sorpassante",
        "op_table_overtaken": "Sorpassato",
        "op_table_position": "Posizione",
    },
    "en": {
        "page_title": "OpenF1 - Driver Comparison Dashboard",
        ...
        "tab_strategy": "Tyre strategy / pits",
        "tab_ranking": "Lap ranking",
        "tab_race_control_weather": "Race Control + Weather",
        "tab_overtakes_position": "Overtakes + Position",
        ...
        "meetings_loaded_fallback_latest": "Loaded circuits: {count}. Latest available GP: {year} - {meeting}.",
        ...
        "strategy_prompt": "Select a session and two drivers to see tyre strategy, pit stops and degradation.",
        "stints_title": "Stints and compounds",
        "stints_none": "No stints available.",
        "pit_title": "Pit stops and duration",
        "pit_y": "Pit duration (s)",
        "pit_none": "No pit stops available.",
        "deg_title": "Performance / degradation (lap times)",
        "deg_none": "No lap times available.",
        "compound_unknown": "Unknown compound",
        "strategy_driver_summary": "{driver}: stints {count}, last compound {compound}",
        "ranking_title": "Lap-by-lap ranking",
        "ranking_prompt": "Load a session to see position over laps for all drivers.",
        "ranking_no_position": "Position data not available for this session.",
        "ranking_computed_note": "Ranking estimated from lap times (session has no position field).",
        "rcw_prompt": "Load a session to see weather and race control events.",
        "rcw_weather_none": "Weather data not available for this session.",
        "rcw_race_control_none": "No race control events available for this session.",
        "rcw_temp_title": "Track and air temperatures",
        "rcw_conditions_title": "Weather: humidity, wind and rainfall",
        "rcw_time": "UTC time",
        "rcw_temp_y": "Temperature (°C)",
        "rcw_humidity_y": "Humidity (%)",
        "rcw_wind_y": "Wind (m/s)",
        "rcw_summary_weather": "Latest weather: track {track}, air {air}, humidity {humidity}, wind {wind}, rainfall {rain}.",
        "rcw_summary_events": "Race control events: {count}. Latest event: {event}.",
        "rcw_event_unknown": "event unavailable",
        "rcw_table_title": "Race Control timeline",
        "rcw_table_time": "UTC time",
        "rcw_table_category": "Category",
        "rcw_table_flag": "Flag",
        "rcw_table_lap": "Lap",
        "rcw_table_driver": "Driver",
        "rcw_table_message": "Message",
        "op_prompt": "Load a session to see positions and overtakes.",
        "op_position_none": "Position data not available for this session.",
        "op_overtakes_none": "No overtakes available for this session.",
        "op_summary_positions": "Available position samples: {count}.",
        "op_summary_overtakes": "Recorded overtakes: {count}.",
        "op_position_title": "Position timeline",
        "op_time": "UTC time",
        "op_position_y": "Position",
        "op_table_title": "Latest overtakes",
        "op_table_time": "UTC time",
        "op_table_overtaker": "Overtaking",
        "op_table_overtaken": "Overtaken",
        "op_table_position": "Position",
    },
}
